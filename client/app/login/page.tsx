                ...
                <Form {...form}>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 w-72 max-w-full ">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormLabel className="flex justify-end w-full hover:underline text-blue-500"><Link href='/password-reset'>Forgot password ?</Link></FormLabel>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
                        ...
                        <div className="flex justify-center gap-2 items-center">
                            <Typography variant="small">Don&apos;t have an account ? </Typography>  <Link href="/signup" className="text-blue-500 hover:underline"> Signup</Link>
                        </div>
                    </form>
                </Form>
            </div>
